...
export const SimulScript15 = { id: "SimulScript15", category: "Specification", name: "Test 15: Large world with one character", description: "Move character ZQSD", script: () => new Script15() } as ScriptDescriptor